    ...
    for pon in np.arange(0, 1, 0.01):
        ...
        for poffs in np.arange(0, 1, 0.01):
            ...
            if not alpha_s:
                ...
                print("Current poffs causes zero store demand, and online profit: {:.3f}".format(
            ...
            if RE_found:
                print("Given pon={:.5}, a RE is found. poffs: {:.5}, poff: {:.5}.".format(pon, poffs, store_price))
                ...
                print("store profit:{:.5f}, alpha_o:{:.5f}, total: {:.5f}".format(
